...
class h4Player(BasePokerPlayer):
  ...
  def declare_action(self, valid_actions, hole_card, round_state):
    ...
    #factor in opponenet behaviour
    # opp_hand_win_rate = opp_hand_win_rate * 
...
#          print 'End actual opp hand win rate' + str(opp_hand_strength_river)
    ...
    # print 'num_raise' + str(num_raise)
    # print 'num_call' + str(num_call)
